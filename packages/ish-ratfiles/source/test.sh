...
ish_ratfiles_test_all() {
  "${ISH_PACKAGES}/ish-ratfiles/test/bats/bin/bats" --recursive "${ISH_PACKAGES}/ish-ratfiles/test/integration/"
}
...
ish_ratfiles_test_integration() {
  ...
  "${ISH_PACKAGES}/ish-ratfiles/test/bats/bin/bats" --recursive "$test_path"
}
