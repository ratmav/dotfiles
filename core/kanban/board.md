...
4. [implement-package-loading-strategy](tasks/implement-package-loading-strategy.md) - core/ vs packages/ separation
   - [x] Phase 1: Documentation complete (architecture docs, task updates, design finalized)
   - [ ] Phase 2: Execute restructure
     - [ ] Move packages/ish → core
     - [ ] Rename ish-dotfiles → ish-ratfiles (directory, functions, commands)
     - [ ] Update paths, verify tests
